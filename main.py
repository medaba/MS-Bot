...
async def info(m: Message):
    await m.answer(
        ...
        "на мой взгляд, функции, ссылки и практические советы для людей, которые столкнулись с РС. "
        "Сам я такой же пациент и не представляю какие-либо организации или экспертные сообщества. "
        "Помните, что при выборе стратегии лечения стоит полагаться на рекомендации лечащего врача, "
